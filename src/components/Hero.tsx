...
const Hero = () => {
  ...
  const descp = "VASA provides reliable solar solutions to save energy costs and create a sustainable future."
  ...
  return (
    ...
    <p className=" mt-5 text-white text-sm md:text-base lg:text-lg text-center animate-slide-up delay-1000 ease-in">{descp}</p>
    </>
