...
const Footer = () => {
  return (
    <div className="w-screen min-h-[200px] py-2 bg-[#4698d2] text-slate-100 font-Montserrat">
      <div className=" px-8 w-full h-full flex justify-between items-start mt-11">
        {/* quicklinks  */}
