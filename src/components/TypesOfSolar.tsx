...
const services = [
  {
    ...
    description:
      "Ideal for areas with reliable utility service, this system generates electricity and feeds excess power back to the grid.",
    image: "./ongrid.gif",
  },
  {
    title: "Off-grid Solar Power Plant",
    description:
      "Perfect for remote locations, off-grid systems provide reliable energy independence without needing a utility connection.",
    image: "./offgrid.gif",
  },
  {
    title: "Hybrid Solar Power Plant",
    description:
      "Combine grid-tied reliability and backup power flexibility with a hybrid solar power plant for optimal performance.",
    image: "./hybrid.gif",
  },
  {
  ...
  },
  {
    ...
    description:
      "Our lightweight and flexible solar panels are very versatile, making them ideal for both mobile and portable setups.",
    image: "flexsolar.jpg",
  },
];
